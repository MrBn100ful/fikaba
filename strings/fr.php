...
const S_POSTING = 'Répondre'; // Imprime le message dans la barre rouge en haut de l'écran de réponse
const S_NOTAGS = 'Les balises HTML sont rapides.'; // Imprime un message sur le conseil d'administration
const S_NEWTHREAD = 'Nouveau sujet'; // En-tête pour le nouveau formulaire de thread
...
const S_MDTABLE1 = '<th> Supprimer? </ th> <th> N ° de publication </ th> <th> Date </ th> '; // Explai
const S_MDTABLE2 = '<th> IP </ th> <th> Sujet </ th> <th> Commentaire </ th> <th> Image</ th ><th> # de réponse </ th> '; // Explique les noms du panneau de gestion (Nom-> md5)
